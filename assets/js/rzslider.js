    ...
    var module = angular
        ...
        .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function (
            ...
            Slider.prototype = {
                ...
                manageElementsStyle: function () {
                    ...
                    this.alwaysHide(
                        this.selBar, !this.range && !this.options.showSelectionBar
                    )
                    this.alwaysHide(
                        this.leftOutSelBar, !this.range || !this.options.showOuterSelectionBars
                    )
                    this.alwaysHide(
                        this.rightOutSelBar, !this.range || !this.options.showOuterSelectionBars
                    )
         ...
         */
                ...
                getTicksArray: function () {
                    ...
                    for (
                        var value = this.minValue; value <= this.maxValue; value += step
                    ) {
